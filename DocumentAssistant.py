...
class DocumentAssistant:
    ...
    def index_documents(self, documents: List[str]):
        ...
        разделяет документы на чанки (например, по предложениям или фиксированной длине);
        вычисляет эмбеддинги для каждого чанка (можно использовать библиотеку sentence-transformers);
        """
